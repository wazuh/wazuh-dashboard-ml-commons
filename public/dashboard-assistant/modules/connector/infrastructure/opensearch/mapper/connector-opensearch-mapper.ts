...
export class ConnectorOpenSearchMapper {
  static fromRequest(id: string, config: ConnectorOpenSearchCreateDto): Connector {
    return {
      id,
      name: config.name,
  ...
  static fromResponse(id: string, config: ConnectorOpenSearchResponseDto): Connector {
    return {
      id,
      name: config.name,
      description: config.description,
