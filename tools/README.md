...
This script automates the process of updating the version and stage in the Wazuh ML Commons Dashboards plugin repository, using only shell commands.
...
- `VERSION.json`
- `package.json`
- `.github/workflows/4_builderpackage_ml_commons_plugin.yml`
